...
def _create_custom_parser() -> ap.ArgumentParser:
    ...
    parser.add_argument('--animated', type=int,                             help="Use this flag to display the graph animated over an inputted millisecond duration.")

    return parser

def _get_data_files(requested_files:list(str)=None, requested_folder:str=None) -> list(Path):
...
if __name__ == "__main__":
    ...
    # FIXME: This is a temporary test below. REMOVE!
